...
\begin{figure*}[ht]
\centering
\includegraphics[width=0.195\linewidth]{figs/result/carot_rgb}
\includegraphics[width=0.195\linewidth]{figs/result/dowel_rgb}
\includegraphics[width=0.195\linewidth]{figs/result/foam_rgb}
\includegraphics[width=0.195\linewidth]{figs/result/potato_rgb}
\includegraphics[width=0.195\linewidth]{figs/result/tire_rgb}
\vspace{0.2cm}

\includegraphics[width=0.195\linewidth]{figs/result/carot_pc}
\includegraphics[width=0.195\linewidth]{figs/result/dowel_pc}
\includegraphics[width=0.195\linewidth]{figs/result/foam_pc}
\includegraphics[width=0.195\linewidth]{figs/result/potato_pc}
\includegraphics[width=0.195\linewidth]{figs/result/tire_pc}
\vspace{0.2cm}

\includegraphics[width=0.195\linewidth]{figs/result/carot_gt}
\includegraphics[width=0.195\linewidth]{figs/result/dowel_gt}
\includegraphics[width=0.195\linewidth]{figs/result/foam_gt}
\includegraphics[width=0.195\linewidth]{figs/result/potato_gt}
\includegraphics[width=0.195\linewidth]{figs/result/tire_gt}
\vspace{0.2cm}

\includegraphics[width=0.195\linewidth]{figs/result/carot_bl}
\includegraphics[width=0.195\linewidth]{figs/result/dowel_bl}
\includegraphics[width=0.195\linewidth]{figs/result/foam_bl}
\includegraphics[width=0.195\linewidth]{figs/result/potato_bl}
\includegraphics[width=0.195\linewidth]{figs/result/tire_bl}
\vspace{0.2cm}

\includegraphics[width=0.195\linewidth]{figs/result/carot_ours}
\includegraphics[width=0.195\linewidth]{figs/result/dowel_ours}
\includegraphics[width=0.195\linewidth]{figs/result/foam_ours}
\includegraphics[width=0.195\linewidth]{figs/result/potato_ours}
\includegraphics[width=0.195\linewidth]{figs/result/tire_ours}
\vspace{-0.1cm}
\begin{flushleft}
 \hspace{1.5cm} Hole \hspace{2.6cm} Bent  \hspace{2.6cm} Cut  \hspace{2.5cm} Hole and Cut  \hspace{1.5cm} Contamination
 \end{flushleft} 

\vspace{-0.1cm}
\caption{Additional qualitative results of anomaly detection. From top to bottom: input RGB images, point clouds, ground-truth anomaly segmentations, and anomaly maps obtained by our proposed method without and with the visual feature enhancement module $\mathcal{M}_{FE}$. With $\mathcal{M}_{FE}$, the anomaly is accurately located in row 5.}
\label{fig:results2}
\end{figure*}
%---------------------------------------------
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.32\linewidth]{figs/eyecandies/29_image_5}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/41_image_4}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/45_image_5}
\vspace{0.2cm}

\includegraphics[width=0.32\linewidth]{figs/eyecandies/29_depth}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/41_depth}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/45_depth}
\vspace{0.2cm}

\includegraphics[width=0.32\linewidth]{figs/eyecandies/29_normals}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/41_normals}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/45_normals}
\vspace{0.2cm}

\includegraphics[width=0.32\linewidth]{figs/eyecandies/29_mask}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/41_mask}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/45_mask}
\vspace{0.2cm}

\includegraphics[width=0.32\linewidth]{figs/eyecandies/29_ours}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/41_ours}
\includegraphics[width=0.32\linewidth]{figs/eyecandies/45_ours}
